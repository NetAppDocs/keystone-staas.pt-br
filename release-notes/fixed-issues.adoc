...
| Descrição do problema | Após a correção | Corrigido na liberação 
 ...
 a| 
Na aba *Tendência de Consumo* no Digital Advisor, o gráfico de pico de faturamento acumulado mostra valores diferentes para o mesmo período de faturamento quando diferentes intervalos de datas são selecionados.
 a| 
Fixo
 a| 
2026-08-31
 ...
 a| 
Na aba *Tendência de Consumo* do Digital Advisor, o gráfico de tendência de consumo não exibe os dados de consumo do dia atual, mostrando apenas os dados do dia anterior.
 a| 
Fixo
 a| 
2026-08-10
 ...
 a| 
As assinaturas exibem incorretamente o status *Acima do Limite de Burst* no painel do Digital Advisor , apesar do consumo estar dentro dos limites de burst permitidos.
 a| 
Fixo
 a| 
2026-03-30
