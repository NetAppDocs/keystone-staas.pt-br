...
* Todo mês, exporte um arquivo do Keystone Collector e envie-o por e-mail para a equipe de suporte da NetApp . Para obter mais informações sobre como entrar em contato com a equipe de suporte, consulte link:../concepts/support-services.html["Obtenha ajuda com o Keystone"].
