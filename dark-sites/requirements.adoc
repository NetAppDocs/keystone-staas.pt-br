...
---
= Requisitos de instalação do Keystone Collector no modo privado
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Somente os pacotes de terceiro listados acima são compatíveis com o Keystone Collector. A instalação de software adicional não é suportada e pode afetar o desempenho do coletor, coleta de dados e precisão da cobrança.
...
* Todo mês, exporte um arquivo do Keystone Collector e envie-o por e-mail para a equipe de suporte da NetApp. Para obter mais informações sobre como entrar em contato com a equipe de suporte, consulte link:../concepts/support-services.html["Serviços de suporte para o Keystone"].
