...
keywords: Operational models, partner operations, customer operations, roles and responsibilities, 
...
| image:check.png["marca de verificação"] | Nenhum 
|===
Para obter mais informações sobre a implantação, consulte link:../concepts/infra.html["Saiba mais sobre a infraestrutura Keystone"] e link:..//concepts/components.html["Componentes necessários para os serviços Keystone"].
