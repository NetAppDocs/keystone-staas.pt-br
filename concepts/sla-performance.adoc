...
| *Nível de serviço* | Extremo | Premium | Padrão | Valor 
...
Com base no cálculo, os créditos de serviço serão US$ 12.
...
* Os créditos de serviço podem ser aplicados a uma fatura futura. Os créditos de serviço não se aplicam a assinaturas Keystone expiradas. Para saber mais, consulte link:../concepts/support-services.html["Suporte à NetApp Keystone"].
