...
---
= SLO de desempenho para Keystone
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
| *Nível de serviço* | *Capacidade impactada* | * Capacidade comprometida total* | *Taxas de capacidade* | *Dias do calendário afetados* | *Porcentagem de crédito* 
