...
Para obter informações sobre como exibir o consumo em uma configuração do MetroCluster, link:../integrations/capacity-trend-tab.html#reference-charts-for-advanced-data-protection-for-metrocluster["Gráficos de referência para proteção avançada de dados"]consulte .
