...
---
= Saiba mais sobre a infraestrutura Keystone
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Você pode visualizar os detalhes da assinatura e do consumo das suas assinaturas Keystone por meio do NetApp Console ou do Digital Advisor. Para saber mais sobre os relatórios Keystone , consultelink:../integrations/dashboard-overview.html["Visão geral do painel do Keystone"] .
