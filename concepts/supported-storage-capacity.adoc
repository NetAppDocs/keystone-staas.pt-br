...
* Você pode solicitar alterações na capacidade contratada por meio do Console ou do seu Keystone Success Manager (KSM). Para obter informações sobre como solicitar alterações, consulte link:../concepts/support-services.html["Suporte à NetApp Keystone"].
