...
---
= Visualize os volumes ONTAP e os detalhes de armazenamento de objetos para assinaturas Keystone.
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
