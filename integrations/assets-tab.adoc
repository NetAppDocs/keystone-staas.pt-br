...
+
Você visualiza informações detalhadas sobre os volumes nos clusters, incluindo nome do volume, número de série do nó, nome do cluster, nome do host e níveis de serviço de desempenho. Você também pode monitorar a capacidade provisionada, utilização lógica e física, dados frios e dados quentes.
