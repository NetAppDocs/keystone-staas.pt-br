...
* Você deve ter a função *Administrador do Keystone * atribuída para modificar assinaturas. Para saber mais, consultelink:https://docs.netapp.com/console-setup-admin/reference-iam-predefined-roles.html["Saiba mais sobre as funções de acesso do NetApp Console"^] .
...
| Sim | Não 
 ...
 a| 
link:../integrations/options.html#generate-reports-from-console-or-digital-advisor["Gerar relatórios"]
| Sim | Sim 
