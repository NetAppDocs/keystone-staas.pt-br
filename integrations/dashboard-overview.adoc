...
* *Monitorar detalhes da assinatura*: visualize informações detalhadas sobre suas assinaturas Keystone, incluindo níveis de serviço de desempenho (serviços básicos e adicionais, como proteção avançada de dados e Data Infrastructure Insights), uso de capacidade, ativos e alertas.
...
* Embora o Console e o Digital Advisor ofereçam alguns recursos exclusivos, o Console fornece funcionalidades administrativas para o Keystone, permitindo que você gerencie assinaturas e faça os ajustes necessários. Para saber mais, consulte link:https://docs.netapp.com/us-en/console-setup-admin/reference-iam-keystone-roles.html["Funções de acesso Keystone no NetApp Console"^].
...
| Sim | Sim 
 ...
 a| 
link:../integrations/adp-tab.html["Visualizar o consumo e a integridade do MetroCluster"]
| Sim (inclui estado de saúde, visualização da topologia e monitoramento de sincronização) | Sim (apenas dados de consumo) 
