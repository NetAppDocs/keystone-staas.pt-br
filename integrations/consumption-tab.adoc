...
+
O gráfico de linhas exibe dados históricos de consumo e permite que os usuários analisem tendências em um intervalo de datas selecionado. O gráfico mostra métricas como capacidade utilizada (capacidade de storage total, incluindo dados e dados de captura de tela), dados (capacidade de storage usada pelos dados de usuário) e captura de tela (capacidade de storage usada pelos dados de captura de tela), juntamente com a capacidade comprometida e a capacidade de burst. Com base no intervalo de datas da sua consulta, os gráficos de uso mostram até 30 pontos de coleta de dados. Você pode posicionar o cursor do mouse sobre o gráfico para visualizar o detalhamento do uso em cada ponto de coleta de dados.
