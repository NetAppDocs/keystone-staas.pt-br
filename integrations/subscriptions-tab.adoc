...
+
image:console-subscription.png["ver os detalhes da aba de assinatura"]
...
+
** *Número da assinatura*: O número da assinatura Keystone atribuído por NetApp. Assinaturas com o ícone image:metrocluster-icon.png["Símbolo de assinatura do MetroCluster"] são assinaturas MetroCluster. Para saber mais sobre assinaturas MetroCluster, consulte link:../integrations/adp-tab.html["Veja o consumo e o status das suas assinaturas Keystone MetroCluster"].
...
** *Assinaturas vinculadas*: Se você tiver alguma assinatura secundária vinculada à sua assinatura principal, esta coluna lista os números das assinaturas vinculadas à assinatura principal. Esta coluna fica oculta por padrão e é visível somente quando há assinaturas vinculadas disponíveis.
** *Versão do Keystone*: A versão do serviço Keystone que está sendo usada para a assinatura. As regras do plano de tarifas para níveis de serviço de desempenho podem variar entre as versões da assinatura. Para saber mais sobre a versão v1, consulte  https://docs.netapp.com/us-en/keystone/index.html["Serviços de assinatura Keystone | Documentação da versão 1"^]. Esta coluna está oculta por padrão e pode ser habilitada usando o ícone de seleção de colunas image:column-selector.png["ícone do seletor de coluna"].
** *Tipo de uso*: Você pode ter assinado várias versões do Keystone. As regras do plano de tarifas para níveis de serviço de desempenho podem ser diferentes entre as versões da assinatura. Ao observar o valor nesta coluna, você sabe se o tipo de uso é cobrado conforme o uso provisionado, físico ou lógico. Para saber mais sobre a versão 1, consulte  https://docs.netapp.com/us-en/keystone/index.html["Serviços de assinatura Keystone | Documentação da versão 1"^].
...
** *Dias restantes para o vencimento da assinatura*: Exibe um ícone ao lado da data de vencimento para indicar quão próxima a assinatura está do vencimento e se ela será renovada automaticamente. Este status é somente leitura e reflete os termos do seu contrato. Para revisar os detalhes do contrato, consulte link:../integrations/subscription-timeline.html["Veja o cronograma de suas assinaturas Keystone"].
+
Quando a renovação automática está desativada, a cor do ícone indica a proximidade do vencimento:

+
*** *Verde*: restam mais de 120 dias até o vencimento.
*** *Laranja*: Restam entre 91 e 120 dias até o vencimento.
*** *Vermelho*: Faltam menos de 90 dias para o vencimento. Para evitar interrupção no serviço, envie uma solicitação de renovação para o suporte do NetApp Keystone.
*** *Cinza*: A assinatura expirou.
+
Para assinaturas com renovação automática ativada, um ícone de renovação automática é exibido, indicando que a assinatura será renovada automaticamente ao final do período atual.

+

NOTE: Você pode clicar na seta para baixo image:down-arrow.png["ícone de expansão"] no cabeçalho da tabela para expandir todas as assinaturas e visualizar as informações de níveis de serviço de desempenho para cada assinatura simultaneamente. Isso mostra informações detalhadas de capacidade, incluindo uso atual, capacidade comprometida, capacidade provisionada, capacidade de pico e capacidade disponível para todas as assinaturas. Como alternativa, você pode clicar na seta para baixo ao lado da coluna *Expiration date* nas linhas de assinatura individuais para expandi-las uma de cada vez.
...
** *Assinaturas vinculadas*: Se você tiver alguma assinatura secundária vinculada à sua assinatura principal, esta coluna lista os números das assinaturas vinculadas à assinatura principal.
